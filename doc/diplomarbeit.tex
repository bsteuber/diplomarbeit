...
\usepackage{listings}
\usepackage{acronym}
\usepackage[outer=75pt, width=448.13095pt, height=635.5pt]{geometry}
%635.5pt
...
Common Lisp ein gewöhnliches Quote benötigt, die komplizierte Auf\/lösung
...
bisher aufwändige Aufgaben vereinfachen. Da aber MagicL deutlich
...
Benutzerinteraktionen zur Auf\/lösung oder Fehlersuche ermöglichen.
