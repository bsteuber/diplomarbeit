...
anhand der im Lisp-Umfeld üblichen Operatoren Quasiquote\footnote{Neben
  Quasiquote ist auch der Begriff Backquote üblich. Neben dem Quasiquote
  gibt es in Lisp-Sprachen auch ein einfaches Quote, welches einen
...
und wie Templates selbst andere Templates aufrufen können.
...
festgelegt ist. Engines mit einer vollständigen Metaprogrammiersprache
...
Web-Frameworks benutzen PHS oder eine PHP ähnelnde Syntax, um Templates
