...
Code-Generierung ist also ein aktuelles Thema, 

\begin{itemize}
\item viele Werkzeuge
\item dennoch geringe abstraktion da textbasiert
\item lisp seit xy jahren strukturell
\end{itemize}

\lsubsection[intro:goal]{Fragestellungen und Zielsetzung}

\begin{itemize}
\item Lisp-Ansatz (Sexp, inkrem. Compiler) für beliebige Domänen /
Backend-Sprachen verallgemeinern
\item elegante Repräsentation für Sexp-Compiler oder -Parser finden
\item typisierte vs. untypisierte Repräsentation
\end{itemize}
...
universellen Frameworks für S-Expression-Compiler
geschildert. \sref{sexy:arch} erläutert die objektorientierte
...
kategorientheoretischer Konzepte, welche in \sref{magicl:haskats}
beschrieben wird. In \sref{magicl:parser} werden dann spezielle
Kategorien entwickelt, mit deren Hilfe auf elegante Weise Parser
beschrieben werden können. In \sref{magicl:sexp} geht es um das Parsen
