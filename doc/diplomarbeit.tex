...
\begin{itemize}
\item ``Objektfunktional''
\item Interpretiert, dynamisch getypt
\item $\rightarrow$ Laufzeitevaluation
\item Fehler erst beim Laufen auffindbar
\end{itemize}
...
\lsubsection[magic:haskats:coproducts]{Coprodukte: Die Klasse \icode{ArrowChoice}}
