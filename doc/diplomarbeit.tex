...
\begin{titlepage}
\title{Ein Arrow-basiertes Compilerbau-Framework}
...
viele Werkzeuge
dennoch geringe abstraktion <- textbasiert
lisp seit xy jahren strukturell

\lsubsection[intro:goal]{Fragestellungen und Zielsetzung}


Lisp-Ansatz (Sexp, inkrem. Compiler) für beliebige Domänen /
Backend-Sprachen verallgemeinern

elegante Repräsentation für Sexp-Compiler oder -Parser finden

typisierte vs. untypisierte repr.
...
Typinferenz
Currying
Datentypen, newtype, type (Typvariablen)
