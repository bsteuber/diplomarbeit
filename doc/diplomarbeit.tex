...
eine derart kurze Funktion handelt, wurde dies einfach in den Compiler
...
instance Compilable (Import -> Code) Import Code where
  comp (Import modName impArgs) = 
    words $ [text "import"] ++ bef ++ [text modName] ++ aft
...
Spracherweiterung sinnvoll erscheint.

Diese Lösung ist also etwas umständlich, zeigt aber auch die hohe
Flexibilität des Frameworks. 


 Deswegen stellt MagicL alternativ
