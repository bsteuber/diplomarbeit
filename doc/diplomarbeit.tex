...
\title{Prototypen universeller Frameworks für
  \sexp{}-basierte Code-Generierung}
...
Sachen Code-Generierung zu geben.
...
\lchapter[related]{Vorhandene Ansätze}

Diese Kapitel soll einen Überblick über vorhandene Technologien zur
Code-Generierung liefern.  \sref{related:codegen} erläutert verschiedene
Arten der Code-Generierung. In \sref{related:parser} werden Werkzeuge für
...
\lsection[related:codegen]{Code-Generierung}

\todo{Definition} was Code-Generierung bedeutet:
Das automatisiertes Erzeugen von Quelltext. Dennoch gibt es diverse
Unterschiede zwischen Code-Generierungswerkzeugen. \todo{quelle}

So differenziert man zwischen aktiver und passiver
Code-Generierung. Aktiv bedeutet, dass die Generierung wiederholt
...
\lsection[related:lisp]{Lisp und \sexps{}}
...
\lsubsection[related:lisp:cprep]{Vergleich mit dem C-Präprozessor}
\begin{itemize}
...
\lsection[magicl:code]{Code-Generierung}
...
Code-Generierung geeignete Version seiner Implementationssprache, hier
...
\lsection[magicl:disc]{Diskussion}
  ...
  \item[$\Rightarrow$] Hier könnte Code-Generierung helfen
    \begin{itemize}
    \item Modellsprache
