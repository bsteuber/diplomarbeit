...
\lsection[intro:example]{Anwendungsbeispiel}
...
bereitstellt. Slide-Code wird vom Modellierer - hier dem Ersteller einer
Präsentation - geschrieben und vom Slide-Compiler in
...
entspricht dem Entwurfsmuster Komposition\cite[S.182f]{CompositePattern}. Eine
...
Objekten kann als Baum mit benannten Kanten erfolgen.
...
Es gibt drei grundlegende Arten, ein Modell zu repräsentieren, die
...
allem bei statisch typisierten Objekten frühestmöglich erkannt. Dafür ist
...
\sexps{} müssen genausnig als Text gespeichert wie visualisiert
