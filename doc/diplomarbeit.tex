...
von Übersetzungfunktion verwendet. Dies schließt sowohl große, zusammengesetzte
Compiler -- wie beispielsweise einen Übersetzer von Slide-DSL-Quelltext
nach Latex-Quelltest -- als auch im kleine, atomare
Übersetzungseinheiten -- wie ein Makro was lediglich eine Aufzählungsliste
verarbeitet -- ein. Selbiges gilt für Parser und Generatoren.

MagicL bietet 

\lsubsubsection[magicl:model:string]{Werkzeuge für Zeichenketten}
\lsubsubsection[magicl:model:sexp]{Werkzeuge für \sexps}
\lsubsubsection[magicl:model:object]{Werkzeuge für Objekte}
...
\lsection[arch:model]{Modellspezifische Komponenten}
