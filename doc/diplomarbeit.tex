...
\lsection[related:unilang]{Universelle Repräsentationssprachen}
...
\lsubsection[related:unilang:xml]{XML} 
...
- vor allem in Anbetracht der Design-Ziele von XML, denn das \ac{W3C}
...
\begin{itemize}
\item \ac{XML-RPC} benutzt überhaupt keine Attribute
...
\lsubsection[related:unilang:uml]{UML}
...
Beispiel \ac{EMF}: Nicht ausschließlich UML, viele Möglichkeiten (genauer), ausschließlich Java-Backend

\lsubsection[related:unilang:json]{JSON}
...
\lsubsection[related:unilang:sexp]{\sexps}
...
die Daten aus einer Datenbank anzeigt. Ein Template definiert die
...
Eingabe die dynamischen Daten und deren Ausgabe ein fertiges Dokument ist.
...
vorgestellt und miteineander verglichen,
...
\lsubsection[related:templates:lisp]{Lisp}
...
\item Lex / Yacc
  \begin{itemize}
  \item Verschiedene Schritte - lexikalische Analyse, syntaktische Analyse
  \item LALR(1)-Parser
  \end{itemize}
\item javacc
  \begin{itemize}
  \item Integriert \ac{EBNF} mit Java-Code
  \item LL(k)-Parser
  \end{itemize}
\item Treetop
  \begin{itemize}
  \item Ähnlich javacc, für Ruby
  \item Parsing Expression Grammar (PEG)
  \end{itemize}
\item Parsec
  \begin{itemize}
  \item Haskell-Bibliothek
  \item Keine eigene Syntax, embedded \ac{DSL}
  \item Basiert auf Monaden
  \item Kontextsensitiv und beliebiges Lookahead, beste Performance bei LL(1)
  \end{itemize}
\end{itemize}
