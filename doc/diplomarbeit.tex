...
\lsection[sexpproc:sexphs]{\sexp{}-Haskell}
...
\lsubsection[sexpproc:sexphs:spec]{Spezifikation}

\todo{DSL selbst mehr vorstellen (=, where, Operatoren, Klassen usw.)}

\lsubsection[sexpproc:sexphs:model]{Typisiertes Modell}
...
\lsubsection[sexpproc:sexphs:parser]{Parser}
...
\sref{arrowparser:compinterface} zu verwenden und den polymorphe
...
Während das Einlesen von \sexps{} dank der in \sref{sexpproc:sexpparser}
...
\end{code}
zurückliefern, wäre
in \sexp{}-Haskell \sees{sexpproc:sexphs} folgende Funktionsdefinition
nötig:
\begin{code}
...
\lsection[sexpproc:metarec]{Metarekursive Implementation}
...
\lsection[sexpproc:preproc]{Beispiel: Ein simpler Präprozessor}
