...
\sref{related:xml} mit der XML verglichen, außerdem werden dort
...
\lsubsection[related:templates:php]{PHP}

Die Scriptsprache PHP ist von vornherein als Template-System
konstruiert. PHP-Code muss immer von \lstinline+<?php+ und
\lstinline+?>+ umgeben sein, was im Grunde ein Unquote darstellt. Das
...
\lsubsection[related:templates:stringtemplate]{StringTemplate}
...
\item javacc
  \begin{itemize}
  \item Integriert EBNF mit Java-Code
  \item LL(k)-Parser
  \end{itemize}
\item Treetop
  \begin{itemize}
...
\item Parsec
  ...
  \item Keine eigene Syntax, embedded DSL
