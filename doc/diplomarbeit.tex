...
\lchapter[arch]{Das Framework MagicL}

Arrow-Typen:
\begin{itemize}
\item Compiler: $*\ato *$
\item Parser: $[*]\ato *$
\item String-Parser: $[Char]\ato *$
\item \sexp{}-Parser: $[Sexp]\ato *$
\item Makro: $[Sexp]\ato [Sexp]$
\end{itemize}

Komponenten
\begin{itemize}
\item Arrow-Bibliothek
...
enthaltene Compiler
\begin{itemize}
\item String nach Sexp
\item Sexp nach String
\item Sexp-HS nach Haskell
\item Sexp-Comp nach Sexp-HS
\end{itemize}

\fig{magicl_compilers}{Übersicht über in MagicL enthaltene Compiler}

\todo{Architektur: Komponenten, Schichtenmodell}
\todo{Mikroarchitektur: Parser, Makros etc. als Arrows}
\todo{weitere Komponenten hierher verschieben, exectutable etc. vereinfachen}
