...
Latex-Compiler steigt. Dieser Ansatz wird in MagicL's Implementierung
einer Haskell-DSL verfolgt.

\lsection[arch:comp-dsl]{DSL für Compiler-Definition}
...
Konstrukte zur einfachen Makro-Definition, ist aber gleichzeitig integriert

MagicL selbst ist hauptsächlich in Haskell
geschrieben. Meta-Programmierer, die eigene Compiler hinzufügen,
benutzen hingegen ausschließlich eine bereitgestellte Compiler-DSL, 
