...
beliebig typisierter und sprachunabhängiger \cgen{}; benutzt allerdings
beispielsweise zu wenig \cgen{} an, um auch das Optimum an Bedienbarkeit
zu erreichen.
...
diskutiert, welche fundamentalen Designentscheidungen in einem
möglicherweise Nachfolger anders getroffen werden könnten und an welchen
Stellen noch Nachbesserungen oder Erweiterungen möglich sind. Auch
sollen Ideen für \sexp{}-gestützte Modellierung und Verarbeitung
aufgezählt werden, die hier nicht weiter verfolgt wurden, aber
interessante Forschungsrichtungen für die Zukunft darstellen könnten.
...
\icode{Compilable}-Schnittstelle \sref{sexphs:code} ist damit realativ
...
Steuerungs allerdings komplett Baum-basiert ist. Damit wird es
