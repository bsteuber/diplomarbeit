...
instance Show Sexp where
    show = layout 70 . sexp2code

showScode :: Sexp -> String
showScode = layout 70 . scode2code
...
sexp2code :: Sexp -> Code
sexp2code (Sexp str [])     = Text str
sexp2code (Sexp str stream) = prin (Text str : map sexp2code stream)
